        ...
        <form id="kt_account_profile_details_form" class="form">
            <div class="card-body border-top p-9">
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        <div class="image-input image-input-outline image-input-empty" data-kt-image-input="true" style="background-image:url(/assets/userLogo.jpg)">
            ...
            <div class="card-footer d-flex justify-content-end py-6 px-9">
                ...
                <button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit">{{ $t('Common_Save_Changes') }}</button>
            </div>
        </form>
    </div>
</template>
