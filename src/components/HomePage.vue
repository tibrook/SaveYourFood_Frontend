 <template>
  <body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
									...
									<div class="card mb-5 mb-xl-8">
										...
										<div class="card-header align-items-center border-0 mt-4">
											...
											<div class="card-toolbar">
												...
												<!--begin::Menu 1-->
												<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_658cdcf79477c">
													<!--begin::Header-->
													<div class="px-7 py-5">
													...
													<div class="px-7 py-5">
														...
														<div class="mb-10">
															...
															<!--begin::Input-->
															<div>
																<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_658cdcf79477c" data-allow-clear="true">
																	<option></option>
    ...
    <div class="d-flex justify-content-between">
      <img src="../assets/mrpropre.png" alt="" class="logoMrPropre">
      <StepAppli/>
    ...
    <div class="container" >
      <!-- Cards Section -->
      <div class="card" v-for="item in items" :key="item.id" @click="goToPage(item.id)">
        <img :src="item.imgSrc" :alt="item.altText" class="card-img">
        <div class="card-content">
          ...
          <button class="btn-main">{{ $t(item.buttonText) }}</button>
        </div>
      </div>
    </div>
  </div>
...
<script>
import StepAppli from './StepAppli.vue';
import { defineComponent } from 'vue';
import widgetsHomePage from './widgetsHomePage.vue';
