<template>
    ...
    <div class="card-header cursor-pointer">
        ...
        <!--end::Card title-->
        <!--begin::Action-->
        <a href="account/settings.html" class="btn btn-sm btn-primary align-self-center">{{$t('update_settings')}}</a>
        <!--end::Action-->
    </div>
    <!--begin::Card header-->
    <!--begin::Card body-->
    <div class="card-body p-9">
        ...
        <div class="row mb-7">
            ...
            <!--begin::Col-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">Alexandre Guillouet</span>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Row-->
        ...
        <div class="row mb-7">
            ...
            <div class="col-lg-8 fv-row">
                <span class="fw-bold fs-6 text-gray-800 me-2">admin@gmail.com</span>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Input group-->
